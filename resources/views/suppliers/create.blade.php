...
<div class="container rounded-top background-nord16 text-nord6">
    <div class="row">
        <div class="col p-2">
            <label class="" for="">Agregar proveedor</label>
            <p class="">Por favor, completa el siguiente formulario para registrarte.</p>
        </div>
    ...
    <div class="row">
        <form class="row g-3" action="{{ route('suppliers.store') }}" method="post">
            @csrf
             <div class="col">
                <div class="row mb-4">
                    <label for="">Informacion del personal</label>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <select name="documentype" id="documentype" class="form-select form-select-lg mb-3">
                ...
                <div class="row">
                    <label for="idnumber" class="form-label">Numero de documento</label>
                    <div class="input-group input-group-sm mb-3">
                        <input type="text" class="form-control @error('idnumber') is-invalid @enderror" id="idnumber" name="idnumber" value="{{ old('idnumber') }}">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-7">
                      <input type="date" class="form-control form-control-sm @error('datentry') is-invalid @enderror" id="datentry" name="datentry" value="{{ old('datentry') }}">
