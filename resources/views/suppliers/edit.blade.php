...
<div class="container rounded-top background-nord16 text-nord6">
    <div class="row">
        <div class="col p-2">
            <label class="" for="">odificar datos del proveedor</label>
            ...
            @method("PUT")
             <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <input type="text" class="form-control @error('lastname') is-invalid @enderror" id="lastname" name="lastname" value="{{ $supplier->lastname }}">
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <input type="date" class="form-control @error('birthdate') is-invalid @enderror" id="birthdate" name="birthdate" value="{{ $supplier->birthdate }}">
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <select name="documentype" id="documentype" class="form-select form-select-lg mb-3" value="{{ $supplier->documentype }}">
                            <option value="{{ $supplier->documentype }}">{{ $supplier->documentype }}</option>
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <input type="text" class="form-control @error('idnumber') is-invalid @enderror" id="idnumber" name="idnumber" value="{{ $supplier->idnumber }}">
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        <input type="date" class="form-control @error('datentry') is-invalid @enderror" id="datentry" name="datentry" value="{{ $supplier->datentry }}">
