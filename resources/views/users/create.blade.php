...
<div class="container rounded-top background-nord16 text-nord6">
        <div class="row">
            <div class="col p-2">
                <label class="mb-3" for="">Crear un nuevo usuario</label>
                <p class="">Por favor, llena los campos de este formulario para crear un perfil de usuario nuevo.</p>
            </div>
            ...
            @csrf
             <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                        <input type="date" class="form-control form-control-sm @error('birthdate') is-invalid @enderror" id="birthdate" name="birthdate" value="{{ old('birthdate') }}">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                        <select name="documentype" id="documentype" class="form-control form-control-sm">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                        <input type="text" class="form-control form-control-sm @error('idnumber') is-invalid @enderror" id="idnumber" name="idnumber" value="{{ old('idnumber') }}">
